            ...
            <div className="bg-lightgrey py-20" id="blog-section">
                <div className='mx-auto max-w-7xl sm:py-4 lg:px-8 mt-5'>
                    ...
                    <div className="text-center">
                        <h3 className="text-gold text-2xl font-normal tracking-widest">Artikel</h3>
                        <h3 className="text-base sm:text-xl lg:text-4xl font-bold">Daftar Publikasi Pada Seminar</h3>
                    </div>
                        ...
                        {postData.map((items, i) => (
                            <div key={i} >
                                ...
                                <div className='bg-white m-3 px-3 pt-3 pb-12 my-10 shadow-lg rounded-3xl relative'>
                                    ...
                                    <Link href="/">
                                        <h3 className="absolute bg-gold text-white font-semibold hover:bg-black hover:shadow-xl py-3 px-6 rounded-full article-img">{items.time}</h3>
                                    </Link>
